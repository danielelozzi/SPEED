...
SPEED is a Python-based project for processing, analyzing, and visualizing eye-tracking data. Version 5.3.5 introduces a major restructuring, offering two distinct components:
...
SPEED v5.3.5 operates on a two-step workflow designed to save time and computational resources.
