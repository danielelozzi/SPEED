# Welcome to the Official Page for SPEED 4.8.2 - labScoc Processing and Extraction of Eye tracking Data
...
* **YOLO object detection**: pre-fixed and custom object detection using YOLO.
...
SPEED 4.8.2 operates on a two-step workflow designed to save time and computational resources.
