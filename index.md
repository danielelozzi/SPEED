# Welcome to the Official Page for SPEED 5.3.8.2 - labScoc Software Processing and Extraction of Eye tracking Data
...
* **LSL Time Series Viewer**: An interactive window to visualize multi-channel time-series data from any LSL stream in real-time.
...
```bash
pip install speed-analyzer==5.3.8.2
```
...
SPEED 5.3.8.2 operates on a two-step workflow designed to save time and computational resources.
...
*   **LSL Time Series Viewer**: A real-time plotting tool that discovers and displays any LSL data stream on the network, ideal for monitoring live data.
...
SPEED 5.3.8.2 introduces a new feature to convert processed eye-tracking data into a format compatible with the **Brain Imaging Data Structure (BIDS)**, following the [BEP020 for Eye Tracking](https://bids.neuroimaging.io/extensions/beps/bep_020.html) guidelines. This facilitates data sharing and standardization for the research community.
